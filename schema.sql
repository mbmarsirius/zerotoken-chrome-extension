...
--
-- Name: profiles Kullanıcılar kendi profillerini okuyabilir; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Kullanıcılar kendi profillerini okuyabilir" ON public.profiles FOR SELECT USING ((auth.uid() = id));
